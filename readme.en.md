...
- **06 - Lucas (Frontend Strategist):** Technical architect for the UI. Selects and validates the frontend tech stack.

### Execution Layer
- **07 - Amanda (UI/UX):** Visual translator. Creates frontend specs and page workflows based on the selected tech stack.
- **08 - Helena (Prompt Engineer):** AI maestro. Transforms requirements into surgical PRPs (using XML-structured prompts for precision).
- **09 - Antigravity / Gemini (Code Agent):** Performs code execution and automated QA by consuming the documents generated by the crew.
...
**Antigravity/Gemini** runs automated tests and browser validations (Playwright) during the implementation cycle itself, ensuring the delivered code has already met acceptance criteria.
...
- Integrated Validation (QA built into the execution agent)
